...
build_info=combine(path.dirname(path.abspath(__file__)),"../src/stdlib/include/build_info.h")
if argc==2:
	os.remove(build_info)
	exit(0)

bi=open(build_info,"w")
bi.write("/*temp file full of build info, generated by tools/gen_build_info.py.")
...
out=subprocess.Popen(["git","status"], stdout=subprocess.PIPE).communicate()[0]
