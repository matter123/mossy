 ...
 * RFC 3629\endlink to turn a UTF-8 char into
 * a codepoint
 * 
 * @param c pointer to a UTF-8 char
 * 
 ...
 * @details uses the method outlined in
 * \link http://tools.ietf.org/html/rfc3629
 * RFC 3629\endlink to turn a codepoint into
 ...
 * byte UTF-8 char 
 * @details using \link http://tools.ietf.org/html/rfc2279
 * RFC 2279\endlink turn \a code_point to an overlong five
 ...
 * 
 * @param dest a pointer to a buffer at least the size of src
